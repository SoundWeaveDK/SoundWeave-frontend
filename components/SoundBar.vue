<!-- <template>
    <div class=" h-full bg-gray-100 rounded-t-lg">
        ...
        <div class="flex items-center justify-between mb-1 mr-4 ml-4">
            ...
            <div class="h-full flex">
                ...
                <div class="volume block h-full my-auto">
                    <Icon name="fa6-solid:volume-high" class="mr-3 my-auto " size="1em" />
